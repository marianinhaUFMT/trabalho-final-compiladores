...
static const yytype_int16 yyrline[] =
{
     ...
     131,   132,   133,   139,   166,   165,   176,   177,   181,   185,
     194,   217,   216,   285,   284,   318,   323,   327,   328,   329,
     330,   331,   332,   333,   334,   342,   365,   371,   380,   389,
     406,   422,   429,   436,   444,   465,   465,   478,   479,   483,
     490,   502,   503,   504,   510,   511,   512,   513,   529,   530,
     533,   536,   539,   542,   543,   544,   545,   546,   547,   548,
     549
};
#endif
...
#line 140 "parser.y"
        {
            ...
            if (!ts_var_insere(ts, (yyvsp[-1].c).str, (yyvsp[-2].c).tipo)) {
                ...
                makeCodeDeclGlobal(buf, (yyvsp[-1].c).str);
...
#line 263 "parser.y"
        {
            ...
            fprintf(output_file, "%s", (yyvsp[-1].c).code);
...
#line 1516 "parser.tab.c"
  ...
  case 25: /* lista_comandos: lista_comandos comando  */
#line 319 "parser.y"
        {
            strcpy((yyval.c).code, (yyvsp[-1].c).code);
            strcat((yyval.c).code, (yyvsp[0].c).code);
        }
#line 1525 "parser.tab.c"
    break;

  case 26: /* lista_comandos: %empty  */
#line 323 "parser.y"
                    { (yyval.c).code[0] = '\0'; }
#line 1531 "parser.tab.c"
    break;

  case 27: /* comando: declaracao_variavel  */
#line 327 "parser.y"
                            { strcpy((yyval.c).code, (yyvsp[0].c).code); }
#line 1537 "parser.tab.c"
    break;

  case 28: /* comando: atribuicao  */
#line 328 "parser.y"
                             { strcpy((yyval.c).code, (yyvsp[0].c).code); }
#line 1543 "parser.tab.c"
    break;

  case 29: /* comando: condicional  */
#line 329 "parser.y"
                             { strcpy((yyval.c).code, (yyvsp[0].c).code); }
#line 1549 "parser.tab.c"
    break;

  case 30: /* comando: laco  */
#line 330 "parser.y"
                             { strcpy((yyval.c).code, (yyvsp[0].c).code); }
#line 1555 "parser.tab.c"
    break;

  case 31: /* comando: leitura  */
#line 331 "parser.y"
                              { strcpy((yyval.c).code, (yyvsp[0].c).code); }
#line 1561 "parser.tab.c"
    break;

  case 32: /* comando: escrita  */
#line 332 "parser.y"
                               { strcpy((yyval.c).code, (yyvsp[0].c).code); }
#line 1567 "parser.tab.c"
    break;

  case 33: /* comando: comando_return  */
#line 333 "parser.y"
                                { strcpy((yyval.c).code, (yyvsp[0].c).code); }
#line 1573 "parser.tab.c"
    break;

  case 34: /* comando: chamada_funcao ';'  */
#line 335 "parser.y"
        {
            strcpy((yyval.c).code, (yyvsp[-1].c).code);
...
#line 343 "parser.y"
        {
            (yyval.c).code[0] = '\0';
            int is_local;
            SimboloVar *v = busca_variavel_info((yyvsp[-3].c).str, &is_local);
            if (v == NULL) {
                char msg[512];
                ...
                v->inicializada = 1;
                if (is_local) makeCodeAssignLocal((yyval.c).code, (yyvsp[-1].c).code, (yyvsp[-3].c).str, v->offset);
                else           makeCodeAssignGlobal((yyval.c).code, (yyvsp[-1].c).code, (yyvsp[-3].c).str);
            }
        }
#line 1606 "parser.tab.c"
    break;

  case 36: /* condicional: IF '(' expr ')' '{' lista_comandos '}'  */
#line 366 "parser.y"
        {
            (yyval.c).code[0] = '\0';
            int l1 = novoLabel(); int l2 = novoLabel();
            makeCodeIf((yyval.c).code, (yyvsp[-4].c).code, (yyvsp[-1].c).code, "", 0, l1, l2);
        }
#line 1616 "parser.tab.c"
    break;

  case 37: /* condicional: IF '(' expr ')' '{' lista_comandos '}' ELSE '{' lista_comandos '}'  */
#line 372 "parser.y"
        {
            (yyval.c).code[0] = '\0';
            int l1 = novoLabel(); int l2 = novoLabel();
            makeCodeIf((yyval.c).code, (yyvsp[-8].c).code, (yyvsp[-5].c).code, (yyvsp[-1].c).code, 1, l1, l2);
        }
#line 1626 "parser.tab.c"
    break;

  case 38: /* laco: WHILE '(' expr ')' '{' lista_comandos '}'  */
#line 381 "parser.y"
        {
            (yyval.c).code[0] = '\0';
            int l1 = novoLabel(); int l2 = novoLabel();
            makeCodeWhile((yyval.c).code, (yyvsp[-4].c).code, (yyvsp[-1].c).code, l1, l2);
        }
...
#line 390 "parser.y"
        {
            (yyval.c).code[0] = '\0';
            int is_local;
            SimboloVar *v = busca_variavel_info((yyvsp[-2].c).str, &is_local);
            if (v == NULL) {
                char msg[512];
                ...
                v->inicializada = 1;
                makeCodeRead((yyval.c).code, (yyvsp[-2].c).str, is_local, v->offset);
            }
        }
...
#line 407 "parser.y"
        {
            ...
            if (v == NULL) {
                ...
                if (is_local) makeCodeLoadVarLocal(val, (yyvsp[-2].c).str, v->offset);
                else           makeCodeLoadVarGlobal(val, (yyvsp[-2].c).str);
                makeCodeWrite((yyval.c).code, val, (v->tipo == T_STRING));
            }
        }
#line 1674 "parser.tab.c"
    break;

  case 41: /* escrita: WRITE '(' INTEGER ')' ';'  */
#line 423 "parser.y"
        {
            char val[CODE_BUF]; val[0] = '\0';
            makeCodeLoadConst(val, (yyvsp[-2].c).str);
            (yyval.c).code[0] = '\0';
            makeCodeWrite((yyval.c).code, val, 0);
        }
#line 1685 "parser.tab.c"
    break;

  case 42: /* escrita: WRITE '(' FLOAT_CONST ')' ';'  */
#line 430 "parser.y"
        {
            char val[CODE_BUF]; val[0] = '\0';
            makeCodeLoadConst(val, (yyvsp[-2].c).str);
...
#line 1696 "parser.tab.c"
  ...
  case 43: /* escrita: WRITE '(' STRING_CONST ')' ';'  */
#line 437 "parser.y"
        {
            (yyval.c).code[0] = '\0';
            int l_str = novoLabel();
            makeCodeWriteStringLiteral((yyval.c).code, (yyvsp[-2].c).str, l_str);
        }
...
#line 445 "parser.y"
        {
            ...
            if (funcao_atual == NULL) {
                ...
                makeCodeReturn((yyval.c).code, (yyvsp[-1].c).code);
            }
        }
...
#line 466 "parser.y"
        {
            ...
            for (int i = chamada_n_args - 1; i >= 0; i--) {
                strcat((yyval.c).code, temp_arg_codes[i]);
            }
            makeCodeCallEnd((yyval.c).code, chamada_nome, chamada_n_args);
        }
...
#line 484 "parser.y"
        { 
            ...
            arg_code[0] = '\0';
            makeCodeCallPushArg(arg_code, (yyvsp[0].c).code);
            empilha_arg((yyvsp[0].c).tipo, arg_code); 
        }
...
#line 502 "parser.y"
                           { (yyval.c).tipo = T_INT; makeCodeLoadConst((yyval.c).code, (yyvsp[0].c).str); }
#line 1774 "parser.tab.c"
    break;

  case 52: /* expr: FLOAT_CONST  */
#line 503 "parser.y"
                            { (yyval.c).tipo = T_FLOAT; makeCodeLoadConst((yyval.c).code, (yyvsp[0].c).str); }
...
#line 504 "parser.y"
                            {
                                (yyval.c).tipo = T_CHAR;
                                char numlit[8];
                                sprintf(numlit, "%d", (int)(yyvsp[0].c).str[0]);
                                makeCodeLoadConst((yyval.c).code, numlit);
                            }
...
#line 510 "parser.y"
                            { (yyval.c).tipo = T_STRING; (yyval.c).code[0] = '\0'; /* strings: sem codegen ainda (ver limitacao) */ }
#line 1797 "parser.tab.c"
    break;

  case 55: /* expr: TRUE  */
#line 511 "parser.y"
                            { (yyval.c).tipo = T_BOOL; makeCodeLoadConst((yyval.c).code, "1"); }
#line 1803 "parser.tab.c"
    break;

  case 56: /* expr: FALSE  */
#line 512 "parser.y"
                            { (yyval.c).tipo = T_BOOL; makeCodeLoadConst((yyval.c).code, "0"); }
...
#line 514 "parser.y"
        {
            int is_local;
            SimboloVar *v = busca_variavel_info((yyvsp[0].c).str, &is_local);
            if (v == NULL) {
                char msg[512];
                ...
                (yyval.c).tipo = v->tipo;
                if (is_local) makeCodeLoadVarLocal((yyval.c).code, (yyvsp[0].c).str, v->offset);
                else           makeCodeLoadVarGlobal((yyval.c).code, (yyvsp[0].c).str);
            }
        }
...
#line 529 "parser.y"
                            { (yyval.c).tipo = (yyvsp[0].c).tipo; strcpy((yyval.c).code, (yyvsp[0].c).code); }
...
#line 530 "parser.y"
                            { (yyval.c).tipo = compativel((yyvsp[-2].c).tipo, (yyvsp[0].c).tipo) ? (yyvsp[-2].c).tipo : T_INDEFINIDO;
                               ...
                               strcpy((yyval.c).code, (yyvsp[-2].c).code); makeCodeAdd((yyval.c).code, (yyvsp[0].c).code); }
...
#line 533 "parser.y"
                            { (yyval.c).tipo = compativel((yyvsp[-2].c).tipo, (yyvsp[0].c).tipo) ? (yyvsp[-2].c).tipo : T_INDEFINIDO;
                               if ((yyval.c).tipo == T_INDEFINIDO) erro_semantico("operandos de '-' com tipos incompativeis");
                               strcpy((yyval.c).code, (yyvsp[-2].c).code); makeCodeSub((yyval.c).code, (yyvsp[0].c).code); }
...
#line 536 "parser.y"
                            { (yyval.c).tipo = compativel((yyvsp[-2].c).tipo, (yyvsp[0].c).tipo) ? (yyvsp[-2].c).tipo : T_INDEFINIDO;
                               if ((yyval.c).tipo == T_INDEFINIDO) erro_semantico("operandos de '*' com tipos incompativeis");
                               strcpy((yyval.c).code, (yyvsp[-2].c).code); makeCodeMul((yyval.c).code, (yyvsp[0].c).code); }
...
#line 539 "parser.y"
                            { (yyval.c).tipo = compativel((yyvsp[-2].c).tipo, (yyvsp[0].c).tipo) ? (yyvsp[-2].c).tipo : T_INDEFINIDO;
                               if ((yyval.c).tipo == T_INDEFINIDO) erro_semantico("operandos de '/' com tipos incompativeis");
                               strcpy((yyval.c).code, (yyvsp[-2].c).code); makeCodeDiv((yyval.c).code, (yyvsp[0].c).code); }
#line 1867 "parser.tab.c"
    break;

  case 63: /* expr: expr EQ expr  */
#line 542 "parser.y"
                            { (yyval.c).tipo = T_BOOL; strcpy((yyval.c).code, (yyvsp[-2].c).code); makeCodeRel((yyval.c).code, (yyvsp[0].c).code, "=="); }
...
#line 548 "parser.y"
                            { (yyval.c).tipo = T_BOOL; strcpy((yyval.c).code, (yyvsp[0].c).code); makeCodeNot((yyval.c).code); }
